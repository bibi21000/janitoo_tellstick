...
DOCKERVOLS   = --privileged -v /dev/bus/usb:/dev/bus/usb
DOCKERPORT   = 8885
...
deps: /etc/apt/sources.list.d/telldus.list
...
telldus-python/setup.py:
	mkdir telldus-python
	cd telldus-python && wget https://raw.githubusercontent.com/bibi21000/telldus/master/bindings/python/native/MANIFEST.in
	cd telldus-python && wget https://raw.githubusercontent.com/bibi21000/telldus/master/bindings/python/native/telldus.c
	cd telldus-python && wget https://raw.githubusercontent.com/bibi21000/telldus/master/bindings/python/native/setup.py
